...
class odwpglt_individual extends main_wcp {
	// properties
...
EOC;
		...
		$info_cards_section  = <<<EOC
									<div class="odwpglt-info_cards_section row">
										<div class="col-md-4">
											<h4 class="odwpglt-info_card--title">$info_common_title</h4>
											<div class="odwpglt-info_card">
												<span class="odwpglt-info_card--label">$info_common_label1</span>
												<span class="odwpglt-info_card--value">$info_common_value1</span>
												<span class="odwpglt-info_card--label">$info_common_label2</span>
												<span class="odwpglt-info_card--value">$info_common_value2</span>
												<div style="clear:both"></div>
											</div>
										</div>
										<div class="col-md-4">
											<h4 class="odwpglt-info_card--title">$info_address_title</h4>
											<div class="odwpglt-info_card">
												<span class="odwpglt-info_card--label">$info_address_label1</span>
												<span class="odwpglt-info_card--value">$info_address_value1</span>
