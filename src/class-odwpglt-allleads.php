...
/**
 * Copy of original WPC class.
 * @see allleads
 * @since 0.0.1
 */
class odwpglt_allleads extends odwpglt_front {
    // properties
...
EOC;
        ...
        $wcp_main .= <<<EOC
                        ...
                        <table class="wcp-table odwpglt-table">
...
EOC;
            ...
            if ($this->can_edit) { // user can edit leads
                ...
                $wcp_main .= <<<EOC
                                ...
                                <td class='edit-td'>
                                    <a class="odwpglt-lead_campaigns lead-id-{$lead['wcp_lead_id']}" href="$campaigns_link" title="$campaigns_link_lbl">
                                        <i class="wcp-sm md-receipt""> </i>
                                    </a>
